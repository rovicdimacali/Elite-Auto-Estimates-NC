<template>
  <section class="who-we-are col">
    ...
    <div class="card" data-aos="zoom-in" data-aos-duration="2000">
      <h3>Estimating Platforms We're Certified In</h3>
      <p>
        We are fully certified in a variety of industry-standard estimating
        platforms, enabling us to deliver fast, precise, and insurer-compliant
        damage evaluations. Our certifications include leading insurance
        carrier-preferred platforms and collision estimating software widely
        recognized for accuracy and efficiency. We also specialize in heavy
        equipment valuation tools and total loss valuation systems, which allow
        us to handle complex claims with confidence. Additionally, we utilize
        integrated parts procurement networks to streamline the repair process,
        reduce downtime, and support effective supply chain management. Our
        expertise in these platforms ensures seamless communication and
        reporting across the entire claims lifecycle.
      </p>
    </div>
  </section>
</template>
